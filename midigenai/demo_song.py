...
GM7, CM7 = [67, 70, 74, 77], [67, 70, 72, 75]                  # Gm7 / Cm7 (top voicings)
G1 = 31
...
def t_stab(b0, bar):
    ...
    hits = [(0.5, 0.2, 100), (1.5, 0.2, 84), (2.5, 0.35, 100), (3.75, 0.2, 90)]
    if sec == "break": hits = [(0.5, 0.6, 90), (2.5, 0.9, 96)]
...
# G minor pentatonic riffs (67 70 72 74 77), 16th-based, each done by beat 3.5
R = None
T_CALLS = [
    t_seq([(67, .25), (70, .25), (72, .5), (R, .5), (74, .25), (72, .25), (70, .5), (67, .5), (R, 1)]),
    t_seq([(74, .5), (R, .25), (74, .25), (77, .5), (74, .5), (72, .25), (70, .25), (67, .5), (R, 1)]),
    t_seq([(67, .25), (67, .25), (R, .25), (67, .25), (70, .5), (72, .5), (R, .5), (74, .5), (R, 1)]),
    t_seq([(79, .5), (77, .25), (74, .25), (R, .5), (72, .5), (70, .25), (67, .25), (R, .5), (65, .5), (R, .5)]),
    t_seq([(72, .25), (74, .25), (72, .25), (70, .25), (67, .5), (R, .5), (70, .25), (72, .25), (74, .5), (R, 1)]),
    t_seq([(67, .5), (R, .5), (74, .5), (R, .5), (72, .25), (70, .25), (67, .5), (R, 1)]),
    t_seq([(70, .25), (72, .25), (74, .25), (77, .25), (79, .5), (R, .5), (77, .25), (74, .25), (72, .5), (R, 1)]),
    t_seq([(67, .25), (R, .25), (67, .25), (R, .25), (70, .25), (R, .25), (72, .5), (74, .5), (R, 1.25)]),
    t_seq([(74, 1), (72, .5), (70, .5), (67, 1), (R, 1)]),
    t_seq([(79, .5), (R, .5), (77, .5), (R, .5), (74, 1), (R, 1)]),
    t_seq([(67, .5), (70, .5), (72, 1), (70, .5), (67, .5), (R, 1)]),
    t_seq([(72, .25), (74, .25), (77, .5), (R, .5), (74, .5), (72, 1), (R, 1)]),
    t_seq([(79, .25), (79, .25), (R, .25), (79, .25), (77, .25), (74, .25), (R, .5), (72, .25), (74, .25), (77, .5), (R, 1)]),
    t_seq([(67, .25), (72, .25), (67, .25), (74, .25), (67, .25), (77, .25), (R, .5), (74, .5), (R, 1.25)]),
    t_seq([(70, .5), (72, .25), (74, .25), (R, .5), (77, .25), (79, .25), (R, .5), (82, .5), (R, 1)]),
    t_seq([(74, .25), (74, .25), (74, .25), (77, .25), (74, .5), (72, .5), (70, .25), (67, .25), (R, .5), (R, 1)]),
    t_seq([(67, .5), (R, .25), (67, .25), (70, .25), (R, .25), (72, .25), (R, .25), (74, .5), (72, .5), (R, 1)]),
    t_seq([(79, .25), (77, .25), (74, .25), (72, .25), (70, .25), (67, .25), (R, .5), (65, .5), (67, .5), (R, 1)]),
    t_seq([(72, .5), (74, .5), (R, .5), (77, .5), (R, .5), (79, .5), (R, 1)]),
    t_seq([(67, .25), (R, .25), (70, .25), (R, .25), (72, .25), (R, .25), (74, .25), (R, .25), (77, 1), (R, .5)]),
]
...
def t_chord_call(k):
    ...
    seqs = [[GM7, GM7, GM7, CM7], [GM7, CM7, GM7, [65, 69, 72, 77]], [GM7, GM7, CM7, CM7]]
    ...
    for b, chord in enumerate(chords):
        for t, d, v in hits:
            if b == 3 and t == 3.75:
                continue                                  # leave the last 16th clear
